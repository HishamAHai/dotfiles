...
local utils = require("widgets.volume-widget-new.utils")
...
local widget_types = {
    icon_and_text = require("widgets.volume-widget-new.widgets.icon-and-text-widget"),
    icon = require("widgets.volume-widget-new.widgets.icon-widget"),
    arc = require("widgets.volume-widget-new.widgets.arc-widget"),
    horizontal_bar = require("widgets.volume-widget-new.widgets.horizontal-bar-widget"),
    vertical_bar = require("widgets.volume-widget-new.widgets.vertical-bar-widget")
}
local volume = {}
