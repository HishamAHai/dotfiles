...
if [ $selected = "recording" ]; then
    ...
    sed -i '187s/0.085/0.115/' $HOME/.config/awesome/widgets/Weather_widget.lua
    sed -i '188s/0.127/0.155/' $HOME/.config/awesome/widgets/Weather_widget.lua
    ...
    sed -i '187s/0.115/0.085/' $HOME/.config/awesome/widgets/Weather_widget.lua
    sed -i '188s/0.155/0.127/' $HOME/.config/awesome/widgets/Weather_widget.lua
