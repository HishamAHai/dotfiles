...
if [ $selected = "recording" ]; then
    ...
    sed -i '172s/0.085/0.115/' $HOME/.config/awesome/widgets/Weather_widget.lua
    sed -i '173s/0.12/0.155/' $HOME/.config/awesome/widgets/Weather_widget.lua
    ...
    sed -i '172s/0.115/0.085/' $HOME/.config/awesome/widgets/Weather_widget.lua
    sed -i '173s/0.155/0.12/' $HOME/.config/awesome/widgets/Weather_widget.lua
