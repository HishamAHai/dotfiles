...
if [ $selected = "recording" ]; then
    ...
    sed -i '190s/0.085/0.115/' $HOME/.config/awesome/widgets/Weather_widget.lua
    sed -i '191s/0.12/0.155/' $HOME/.config/awesome/widgets/Weather_widget.lua
    ...
    sed -i '190s/0.115/0.085/' $HOME/.config/awesome/widgets/Weather_widget.lua
    sed -i '191s/0.155/0.12/' $HOME/.config/awesome/widgets/Weather_widget.lua
