...
export PATH=$HOME/.local/bin:/usr/local/bin:$HOME/tinyMediaManager:$HOME/Applications:$HOME/.local/share/flatpak/exports/bin:/var/lib/flatpak/exports/bin:$PATH
